...
LOGISTIC_FIELDS = ["log_out_file_doc_id", "log_in_file_doc_id", "logistics_center"]
            ...
            if qty_by_prod[item] > 0:
                ...
                # move out raise an alert
                    ...
                    raise models.except_models(
                        _("Warning !"),
                        _(
                            "Too much product delivered for picking '%s' (id %s)"
